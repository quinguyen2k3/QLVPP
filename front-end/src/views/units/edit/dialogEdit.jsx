...
import { useGetOneUnit } from '../hooks/useGetOneUnit';
import { useUpdateUnit } from '../hooks/useUpdateUnit';

const EditDialog = ({ unitId, open, onClose, onSuccess }) => {
  const { t } = useTranslation();
  const { unit, loading: loadingGet } = useGetOneUnit(unitId, open);
  ...
  const formik = useFormik({
    ...
    initialValues: {
      name: unit?.name || '',
      note: unit?.note || '',
      isActivated: unit?.isActivated ?? true,
    },
    validationSchema,
